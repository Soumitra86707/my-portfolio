...
const Navbar = () =>{
    ...
    return(
        ...
        <div className={`w-full px-4 sm:px-8 py-3 fixed z-10 ${Nav ? 'bg-gray-900' : ''}`}>
           ...
           <div className="flex flex-row justify-between  items-center">
            ...
            <div className="text-2xl font-bold text-cyan-500 flex items-center gap-3">
                    <img src={soumitra} alt="Error" className="w-[50px] md:w-[50px] h-[50px] rounded-full"/>
        ...
        { toggle_top == true && 
        <div className="bg-green-800 p-3 rounded-full shadow-lg shadow-cyan-500/70 z-10 top-[90%] left-[83%] md:left-[95%] fixed cursor-pointer" data-aos="zoom-in-out"
            onClick={ScrollTop}>
